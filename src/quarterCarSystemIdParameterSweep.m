...
parfor sampIter = 1:numSampTimes
    ...
    avgFitArraySB(sampIter,:,:,:,:) = avgFitArraySBVel;
    avgFitArrayStep(sampIter,:,:,:,:)= avgFitArrayStepVel;
    timeCostArray(sampIter,:,:,:) = timeCostArrayVel;
